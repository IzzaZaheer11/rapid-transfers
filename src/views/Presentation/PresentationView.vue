        ...
        <div class="row">
          <div class="col-lg-7 text-center mx-auto position-relative">
            ...
            <p class="lead text-white px-5 mt-3" :style="{ fontWeight: '800' }">
              ...
              <br />Airport transfers or city-to-city in Barcelona from 50€
            </p>
            <a
            ...
            <div class="d-flex justify-content-center p-5">
              <div class="col-lg-8 ms-lg-5 text-center">
                ...
                <p class="text-white text-md">
                  ...
                  below to navigate to Creative Tim where you can
                  <br />find the Design System in HTML. Start a new project or give an
